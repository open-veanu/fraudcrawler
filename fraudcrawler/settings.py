...
REDIS_CACHE_NAMESPACE_SEARCHER = f"{REDIS_CACHE_NAMESPACE}:searcher"
REDIS_CACHE_NAMESPACE_ENRICHER = f"{REDIS_CACHE_NAMESPACE}:enricher"
REDIS_CACHE_NAMESPACE_ZYTEAPI = f"{REDIS_CACHE_NAMESPACE}:zyteapi"
REDIS_CACHE_NAMESPACE_WORKFLOWS = f"{REDIS_CACHE_NAMESPACE}:workflows"
REDIS_CACHE_TTL = 3600

REDIS_URL_COLLECTOR_DB = 1
REDIS_URL_COLLECTOR_NAMESPACE = "urls"
REDIS_URL_COLLECTOR_TTL = 3600
